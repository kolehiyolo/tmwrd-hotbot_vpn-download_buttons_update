<?php /* Template Name: Program-CJ page */ ?>
<?php get_header();?>
    <section class="layout-section layout-section--affiliate-hero text-align-center--md pb-5 pb-md-7">
        ...
        <?php include 'inc/inc-header-CJ-publisher-program.php'; ?>
            ...
            <div class="row align-items-center">
                <div class="col-md-6" id="app2">
                    ...
                    <div class="d-md-flex flex-wrap">
                        <a href="https://signup.cj.com/member/signup/publisher/?cid=6065541" class="btn btn--primary-darken has-arrow mb-5"><span><?php esc_html_e('Join our program on CJ', 'hotbot' ); ?>
                ...
                <div class="col-xl-8">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="row">
                                <div class="col-md-11 pb-md-3 mb-md-3">
                                    <img src="<?php the_field('points_1_img'); ?>" class="mb-5 img-size-120 m-auto ml-md-0" alt="40% Lifetime Revshare"  />
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="row">
                                <div class="col-md-11 pb-md-3 mb-md-3">
                                    <img src="<?php the_field('points_2_img'); ?>" class="mb-5 img-size-120 m-auto ml-md-0" alt="40% Lifetime Revshare"  />
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="row">
                                <div class="col-md-11 pb-md-3 mb-md-3">
                                    <img src="<?php bloginfo('template_url'); ?>/assets/img/affiliate-subscription.svg" class="mb-5 img-size-120 m-auto ml-md-0" alt="40% Lifetime Revshare"  />
                                    <h3 class="heading mt-4"><?php esc_html_e('100% Commission on monthly purchase.', 'hotbot' ); ?></h3>
                                    <p><?php _e('50% for multi-month purchases If you need a different structure we are flexible. <a href="/affiliate-support/" class="text-color-primary">Contact us</a> for private offers.', 'hotbot' ); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="row">
                                <div class="col-md-11 pb-md-3 mb-md-3">
                                    <img src="<?php bloginfo('template_url'); ?>/assets/img/affiliate-monthly-pay.svg" class="mb-5 img-size-120 m-auto ml-md-0" alt="Monthly Payments"  />
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <p class="d-flex align-items-center"><a href="/affiliate-support/" class="mr-5 d-inline-block white-space-nw bold link-lite-text rtl-mr-5 "><?php esc_html_e('Get Help', 'hotbot' ); ?></a> <a href="https://signup.cj.com/member/signup/publisher/?cid=6065541" class="btn btn--primary-darken has-arrow btn--xs"><span><?php esc_html_e('Join our program on CJ', 'hotbot' ); ?>
