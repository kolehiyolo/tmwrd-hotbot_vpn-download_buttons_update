  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 ">
        ...
        <h4 class="heading mb-md-5"><?php esc_html_e('<svg class="listing__icon"><use xlink:href="#check-circle-solid"></use></svg> and downloading large files online.', 'hotbot'); ?></h4>
