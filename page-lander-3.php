<?php /* Template Name: Lander 3 page */ ?>
<?php get_header();?>
...
<section class="layout-section layout-section--lander-bg  pb-5">
  ...
  <div class="lander-hero pt-3 pb-5 mb-3">
    <picture>
        <source srcset="<?php bloginfo('template_url'); ?>/assets/img/lander-hero-3.webp" type="image/webp">
        <source srcset="<?php bloginfo('template_url'); ?>/assets/img/lander-hero-3.png" type="image/png"> 
        <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assets/img/lander-hero-3.png" class="lander-hero__img">
    </picture>
    ...
    <div class="container text-align-center--md">
      <div class="row align-items-center">
        <div class="col-md-7">
            ...
            <h4 class="heading heading--light d-none danger" id="getDealNow">EXPIRED</h4>
            <div class="container-fluid mt-3">
                <div class="row text-align-center justify-content-center justify-content-md-start" id="countDOwn">
                    <div class="pl-2 pr-2">
                        <h2 class="heading heading--light mt-0 mb-0" id="minutes">5</h2>
                        <span class="small danger">MINUTES</span>
                    </div>
                    <div class="devider-y ml-3 mr-3">
                    </div>
                    <div class="pl-2 pr-2">
                        <h2 class="heading heading--light mt-0 mb-0" id="seconds">00</h2>
                        <span class="small danger">SECONDS</span>
                    </div>
                </div>
            </div>
        </div>
